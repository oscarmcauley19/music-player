...
namespace ProjectDesign.com.wikia.lyrics {
    using System;
    ...
    public partial class LyricWiki : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        private System.Threading.SendOrPostCallback getTopSongsOperationCompleted;
        ...
        /// <remarks/>
        public LyricWiki() {
            this.Url = global::ProjectDesign.Properties.Settings.Default.ProjectDesign_com_wikia_lyrics_LyricWiki;
        ...
        /// <remarks/>
        public event getTopSongsCompletedEventHandler getTopSongsCompleted;
        ...
        public string getAlbum(ref string artist, ref string album, ref int year, out string imgUrl, out string url, out string[] songs) {
            ...
            year = ((int)(results[3]));
            imgUrl = ((string)(results[4]));
            url = ((string)(results[5]));
            songs = ((string[])(results[6]));
            return ((string)(results[0]));
        }
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapRpcMethodAttribute("urn:LyricWiki#getTopSongs", RequestNamespace="urn:LyricWiki", ResponseNamespace="urn:LyricWiki")]
        [return: System.Xml.Serialization.SoapElementAttribute("topSongs")]
        public string[] getTopSongs(string limit) {
            object[] results = this.Invoke("getTopSongs", new object[] {
                        limit});
            return ((string[])(results[0]));
        }
        
        /// <remarks/>
        public void getTopSongsAsync(string limit) {
            this.getTopSongsAsync(limit, null);
        }
        
        /// <remarks/>
        public void getTopSongsAsync(string limit, object userState) {
            if ((this.getTopSongsOperationCompleted == null)) {
                this.getTopSongsOperationCompleted = new System.Threading.SendOrPostCallback(this.OngetTopSongsOperationCompleted);
            }
            this.InvokeAsync("getTopSongs", new object[] {
                        limit}, this.getTopSongsOperationCompleted, userState);
        }
        
        private void OngetTopSongsOperationCompleted(object arg) {
            if ((this.getTopSongsCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.getTopSongsCompleted(this, new getTopSongsCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
        ...
        /// <remarks/>
        public void postSongAsync(bool overwriteIfExists, string artist, string song, string lyrics, string language, string[] onAlbums) {
            this.postSongAsync(overwriteIfExists, artist, song, lyrics, language, onAlbums, null);
        }
        
        /// <remarks/>
        public void postSongAsync(bool overwriteIfExists, string artist, string song, string lyrics, string language, string[] onAlbums, object userState) {
        ...
        /// <remarks/>
        public void postSong_flagsAsync(bool overwriteIfExists, string artist, string song, string lyrics, string[] onAlbums, string flags, string language) {
            this.postSong_flagsAsync(overwriteIfExists, artist, song, lyrics, onAlbums, flags, language, null);
        }
        
        /// <remarks/>
        public void postSong_flagsAsync(bool overwriteIfExists, string artist, string song, string lyrics, string[] onAlbums, string flags, string language, object userState) {
            ...
            this.InvokeAsync("postSong_flags", new object[] {
                        ...
                        onAlbums,
                        flags,
                        language}, this.postSong_flagsOperationCompleted, userState);
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    public delegate void getTopSongsCompletedEventHandler(object sender, getTopSongsCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.7.3056.0")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class getTopSongsCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal getTopSongsCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
